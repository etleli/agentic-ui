...
security clearance. [Dependency advisories](dependency-advisories.md) remain a
separate release gate. Tests compare the packed LICENSE and notice file with the
