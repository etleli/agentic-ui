...
**Current source: fixed**, after all 76 permanent Chromium cases passed in normal
rendering and StrictMode. The identical suite failed 54 of 76 cases against the
